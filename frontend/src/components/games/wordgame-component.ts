...
<div id="wordgame" class="game">
  ...
  <script type="text/javascript" defer>
      ...
      function setEventListeners() {
          let htmlLetterTags = document.getElementsByClassName("letter");

          for(let currTag: HTMLElement in htmlLetterTags) {
              currTag.addEventListener("click", setEingabe(currTag.id));
              console.log(currTag.id + "worked")
          }
      }
